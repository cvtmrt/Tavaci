...
const varsayilan = {
  tr: {
    ...
    // --- Franchise sayfası ---
    "franchise.title": "Franchise Fırsatı",
    "franchise.sub": "1998'den beri közün lezzetini taşıyan Tavacı Mehmet ailesine siz de katılın. Başvurunuzu doldurun, ekibimiz en kısa sürede sizinle iletişime geçsin.",
    "franchise.benefit1.title": "Kanıtlanmış Marka",
    "franchise.benefit1.text": "1998'den beri güçlenen marka bilinirliği ve sadık müşteri kitlesi.",
    "franchise.benefit2.title": "Uçtan Uca Destek",
    "franchise.benefit2.text": "Lokasyon seçimi, kurulum, eğitim ve operasyonda yanınızdayız.",
    "franchise.benefit3.title": "Kârlı İş Modeli",
    "franchise.benefit3.text": "Test edilmiş menü, standart reçeteler ve verimli işletme modeli.",
    "franchise.name": "Ad Soyad",
    "franchise.phone": "Telefon",
    "franchise.email": "E-posta",
    "franchise.city": "Şube Açmak İstediğiniz Şehir",
    "franchise.message": "İş Deneyiminiz / Notunuz",
    "franchise.send": "WhatsApp ile Başvuru Gönder",
    "franchise.thanks": "Başvurunuz alındı! En kısa sürede sizinle iletişime geçeceğiz. 🎉",
    "franchise.note": "Başvurunuz WhatsApp üzerinden iletilir.",
  },
  ...
  en: {
    ...
    "franchise.sub": "Join the Tavacı Mehmet family that has carried the flavor of charcoal since 1998. Fill out your application and our team will get in touch with you shortly.",
    "franchise.benefit1.title": "Proven Brand",
    "franchise.benefit1.text": "Growing brand recognition and a loyal customer base since 1998.",
    "franchise.benefit2.title": "End-to-End Support",
    "franchise.benefit2.text": "We're with you in location selection, setup, training and operations.",
    "franchise.benefit3.title": "Profitable Model",
    "franchise.benefit3.text": "A tested menu, standard recipes and an efficient business model.",
    "franchise.name": "Full Name",
    "franchise.phone": "Phone",
    "franchise.email": "Email",
    "franchise.city": "City You Want to Open In",
    "franchise.message": "Your Experience / Note",
    "franchise.send": "Send Application via WhatsApp",
    "franchise.thanks": "Your application has been received! We'll contact you shortly. 🎉",
    "franchise.note": "Your application is sent via WhatsApp.",
  },
};
